...
export default function CardBook({ description, name, img, price, id, visible, mota }) {
  ...
  return (
<div className="mb-4 mx-3 relative rounded-lg shadow-lg p-3 h-[480px] w-[250px] bg-white group">
  <div className="relative overflow-hidden rounded-md h-[280px] w-full">
    ...
    <div className="absolute inset-0 bg-black bg-opacity-50 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <p className="text-center px-4 h-[80px] group-hover:h-[120px] overflow-hidden transition-all duration-300">
        {mota}
      </p>
    </div>
  </div>
